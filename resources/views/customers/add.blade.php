...
@section('container')
    ...
    <div class="customer_add block_container">
        ...
        <form class="form-inline" method=POST action="{{ route('customer_store') }}" accept-charset="UTF-8" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class=" col-lg-6 col-md-12 col-sm-12">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class=" col-md-8 col-sm-12">
                                        <select required class='form-control' name='store_category' id='store_category'>
                                            <option value=''>- Select a Category -</option>
                                            @foreach($storeCategories as $storeCategory)
                                                <option value="{{ $storeCategory->id }}">{{ $storeCategory->description }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
